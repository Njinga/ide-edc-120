    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-lg-9">
            <div data-spy="scroll" class="scrollspy-example z-depth-1 mt-4 shadow-lg p-3 mb-5 rounded" data-target="#navbar-example3"
                ...
                <div class="note note-secondary text-justify meme">
                    Once you have formulated an idea, <i>you need to build on that idea by translating the
                    general idea into clear-cut and specific statement of one or more objectives for the
                    planned learning within an instructional context.</i>
                </div>
                <p class="text-justify meme">
                ...
                <p class="text-justify meme">
                    <ul>
                        ...
                        <li>
                            ...
                            Ask yourself the question: <i>'What needs to be constructed so that the 
                            activities are successful?'</i> For example, <i>'Do my students need some explanation, 
                            guided practice or some observation?'</i>
                        </li>
                        <li>
                            Reflect on what you know or have seen. For instance, <i>Can I talk to a teacher who has
                            taught similar concepts before?</i>
                        </li>
                        <li>
                            Put yourself in the learners' shoes. <i>What would I want to experience 
                            in order to effectively learn the materials?</i>
                        </li>
                        <li>
