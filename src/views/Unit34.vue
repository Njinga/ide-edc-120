    ...
    <div class="row">
        <div class="col-sm-4 col-lg-3">
            <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                ...
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link active" href="#item-1">3.4 Media Selection Models</a>
                    <nav class="nav nav-pills flex-column">
                        <a class="nav-link ml-3 my-1" href="#item-1-1">3.4.1 The basic model</a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-5 my-1" href="#item-1-1-1">3.4.1.1 Selection of media</a>
                        </nav>
                        <a class="nav-link ml-3 my-1" href="#item-1-2">3.4.2 Steps to follow in systematic
                        planning for the use of media (ASSURE Model)</a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-5 my-1" href="#item-1-2-1">3.4.2.1 Analyse the learners</a>
                            <a class="nav-link ml-5 my-1" href="#item-1-2-2">3.4.2.2 State objectives</a>
                            <a class="nav-link ml-5 my-1" href="#item-1-2-3">3.4.2.3 Select methods, media, and materials</a>
                            <a class="nav-link ml-5 my-1" href="#item-1-2-4">3.4.2.4 Utilize media and materials</a>
                            <a class="nav-link ml-5 my-1" href="#item-1-2-5">3.4.2.5 Require learner participation</a>
                            <a class="nav-link ml-5 my-1" href="#item-1-2-6">3.4.2.6 Evaluate and revise</a>
                        </nav>
                    </nav>
        ...
        <div class="col-sm-8 col-lg-9">
            <div data-spy="scroll" class="scrollspy-example z-depth-1 mt-4 shadow-lg p-3 mb-5 rounded" data-target="#navbar-example3"
                 data-offset="0">
                <h2 id="item-1" class="h2-responsive">3.4 Media Selection Models</h2>
                ...
                <h3 id="item-1-1" class="h3-responsive">3.4.1 The basic model </h3>
                <p class=" text-justify meme">
                ...
                <h4 id="item-1-1-1" class="h4-responsive">3.4.1.1 Selection of media</h4>
                <p class=" text-justify meme">
                ...
                <h3 id="item-1-2" class="h3-responsive">
                ...
                <br />
                <h4 id="item-1-2-2" class="h4-responsive">3.4.2.2 State objectives</h4>
                <p class=" text-justify meme">
                ...
                <br />
                <h4 id="item-1-2-3" class="h4-responsive">3.4.2.3 Select methods, media, and materials</h4>
                <p class=" text-justify meme">
                ...
                <br />
                <h4 id="item-1-2-4" class="h4-responsive">3.4.2.4 Utilize media and materials</h4>
                <p class=" text-justify meme">
                ...
                <br />
                <h4 id="item-1-2-5" class="h4-responsive">3.4.2.5 Require learner participation</h4>
                <p class=" text-justify meme">
                ...
                <br />
                <h4 id="item-1-2-6" class="h4-responsive">3.4.2.6 Evaluate and revise</h4>
                <p class=" text-justify meme">
                ...
                <p class=" text-justify meme">
                    ...
                    <i>Did students' achievement fall short on any of the objectives? How did the students 
                    react to the use of media and materials? Are you satisfied with the media you used and the way you used it?</i>
