<template>
    <div class="border border-info p-3 mb-5 bg-light rounded b">
    ...
    <div class="row">
        <div class="col-sm-4 col-lg-3">
            <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                ...
                <nav class="nav nav-pills flex-column">
                    ...
                    <nav class="nav nav-pills flex-column">
                        <a class="nav-link ml-2 my-1" href="#item-1-1">2.3.1 Non-projected media </a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-3 my-1" href="#item-1-1-1">2.3.1.1 Printed materials</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-1-2">2.3.1.2 Non-projected visuals</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-1-3">2.3.1.3 Non-projected display surfaces</a>
                        </nav>
                        <a class="nav-link ml-2 my-1" href="#item-1-2">2.3.2 Projected media</a>
                        <a class="nav-link ml-2 my-1" href="#item-1-3">2.3.3 Audio media </a>
                        <a class="nav-link ml-2 my-1" href="#item-1-4">2.3.4 Motion media</a>
                        <a class="nav-link ml-2 my-1" href="#item-1-5">2.3.5 Computer based multimedia and hypermedia </a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-3 my-1" href="#item-1-5-1">2.3.5.1 Role of computers in instruction</a>
                        </nav>
                        <a class="nav-link ml-2 my-1" href="#item-1-6">2.3.6 Social Media</a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-3 my-1" href="#item-1-6-1">2.3.6.1 Other capabilities of Social Media</a>
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link ml-4 my-1" href="#item-1-6-1-1">2.3.6.1.1 Wiki</a>
                                <a class="nav-link ml-4 my-1" href="#item-1-6-1-2">2.3.6.1.2 Blogs</a>
                            </nav>
                        </nav>
                        <a class="nav-link ml-2 my-1" href="#item-1-7">2.3.7 Mobile learning technologies</a>
        ...
        <div class="col-sm-8 col-lg-9 border border-light">
            <div data-spy="scroll" class="scrollspy-example z-depth-1 mt-4 shadow-lg p-3 mb-5 rounded" data-target="#navbar-example3"
                 data-offset="0">
                <h2 id="item-1" class="h2-responsive">2.3 Instructional Media Available for Teaching and Learning</h2>
                ...
                <br />
                <h3 id="item-1-1" class="h3-responsive">2.3.1 Non-projected media </h3>
                <p class="text-justify meme">
                ...
                <br />
                <h4 id="item-1-1-1" class="h4-responsive">2.3.1.1 Printed materials</h4>
                <p class="text-justify  meme">
                ...
                <br />
                <h4 id="item-1-1-2" class="h4-responsive">2.3.1.2 Non-projected visuals</h4>
                <p class="text-justify meme">
                ...
                <br />
                <h4 id="item-1-1-3" class="h4-responsive">2.3.1.3 Non-projected display surfaces</h4>
                <p class="text-justify meme">
            ...
            <br />
            <h3 id="item-1-2" class="h3-responsive">2.3.2 Projected media</h3>
            <p class="text-justify meme">
            ...
            <br />
            <h3 id="item-1-3" class="h3-responsive">2.3.3 Audio media </h3>
            <p class="text-justify meme">
            ...
            <br />
            <h3 id="item-1-4" class="h3-responsive">2.3.4 Motion media</h3>
            <p class="text-justify meme">
            ...
            <br />
            <h3 id="item-1-5" class="h3-responsive">2.3.5 Computer based multimedia and hypermedia </h3>
            <p class="text-justify meme">
            ...
            <br />
            <h4 id="item-1-5-1" class="h4-responsive">2.3.5.1 Role of computers in instruction </h4>
            <p class="text-justify meme">
            ...
            <br />
            <h3 id="item-1-6" class="h3-responsive">2.3.6 Social Media</h3>
            <p class="text-justify meme">
            ...
            <br />
            <h4 id="item-1-6-1" class="h4-responsive">2.3.6.1 Other capabilities of Social Media</h4>
            <p class="text-justify meme">
            ...
            <br />
            <h5 id="item-1-6-1-1" class="h5-responsive">2.3.6.1.1 Wiki</h5>
            <p class="text-justify meme">
            ...
            <br />
            <h5 id="item-1-6-1-2" class="h5-responsive">2.3.6.1.2 Blogs</h5>
            ...
            <br />
            <h3 id="item-1-7" class="h3-responsive">2.3.7 Mobile learning technologies</h3>
            <p class="text-justify meme">
