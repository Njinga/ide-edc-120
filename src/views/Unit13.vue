                    ...
                    <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                        ...
                        <nav class="nav nav-pills flex-column">
                            ...
                            <nav class="nav nav-pills flex-column">
                                ...
                                <a class="nav-link ml-3 my-1" href="#item-1-3">1.3.3 Information Technology (IT) equipment</a>
                                <a class="nav-link ml-3 my-1" href="#item-1-4">1.3.4 Telecommunications</a>
                                <a class="nav-link ml-3 my-1" href="#item-1-5">1.3.5 Limitations of ICTs</a>
                                <nav class="nav nav-pills flex-column">
                                    <a class="nav-link ml-5 my-1" href="#item-1-5-1">Activity 1.2</a>
