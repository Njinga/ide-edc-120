                    ...
                    <div data-spy="scroll" class="scrollspy-example z-depth-1 mt-4 shadow-lg p-3 mb-5 rounded" data-target="#navbar-example3"
                        ...
                        <mdb-container fluid>
                            <mdb-row class="bg-primary text-justify">
                                ...
                                <h3 class="h3-responsive">Unit 2</h3>
                                <h3 class="h3-responsive">Media Technologies Used for Teaching and Learning</h3>
                                <br />
                                <h4 id="item-1" class="h4-responsive">2.1 Introduction</h4>
                                <div class="ml-5 text-justify">
                                    ...
                                    <div class=" note note-success meme">
                                        ...
                                        <h4 id="item-1-2" class="h4-responsive"><i class="fas fa-check-square"> Terminolgy</i></h4>
