        ...
        <div class="row">
            <div class="col-sm-4 col-lg-3">
                <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                    ...
                    <nav class="nav nav-pills flex-column">
                        <a class="nav-link active" href="#item-1">3.1 Criteria for Selecting Media during instruction </a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-3 my-1" href="#item-1-1">Activity 3.1</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-2">3.1.1 Criteria for media selection</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-3">3.1.2 Essential media characteristics</a>
                        </nav>
            ...
            <div class="col-sm-8 col-lg-9">
                <div data-spy="scroll" class="scrollspy-example z-depth-1 mt-4 shadow-lg p-3 mb-5 rounded" data-target="#navbar-example3"
                     data-offset="0">
                    <h2 id="item-1">3.1 Criteria for Selecting Media during instruction </h2>
                    ...
                    <h3 id="item-1-2">3.1.1 Criteria for media selection </h3>
                    <p class="text-justify meme">
                    ...
                    <h3 id="item-1-3">3.1.2 Essential media characteristics</h3>
                    <p class="text-justify meme">
