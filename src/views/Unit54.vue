    ...
    <div class="about">
        <mdb-container fluid>
            <mdb-row class="bg-primary text-justify">
                <br />
                <h2 class="h2-responsive">5.4 How to Integrate Media into the Instructional Process</h2>
                ...
                <br />
                <h3 class="h3-responsive">5.4.1 The computer as a teacher</h3>
                <div class="note note-secondary">
                    <p class="text-justify">
                    ...
                    <div class="note note-light text-justify">
                        <blockquote class="blockquote bq-info">
                            <i class="fas fa-tools"> Activity 5.1</i>
                            <br>
                            <i>
                    ...
                    <div class="note note-light text-justify">
                        <blockquote class="blockquote bq-info">
                            <i class="fas fa-tools"> Activity 5.2</i>
                            <br>
                            <i>
                ...
                <br />
                <h3 class="h3-responsive">5.4.2 Computer as learner (Student as teacher)</h3>
                <div class="note note-secondary">
                    <p class="text-justify">
                ...
                <br />
                <h3 class="h3-responsive">5.4.3 Using the Internet to support learning</h3>
                <div class="note note-secondary">
                    <p class="text-justify">
                ...
                <br />
                <h3 class="h3-responsive">5.4.4 Uses of the Internet</h3>
                <div class="note note-secondary">
                    <p class="text-justify">
                        You and your students can use the Internet in a variety of ways. 
                        The main uses of the Internet include; <kk>communication, 
                        information retrieval, and information publishing.</kk>
                    </p>
                    <p class="text-justify">
