                    ...
                    <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                        ...
                        <nav class="nav nav-pills flex-column">
                            ...
                            <nav class="nav nav-pills flex-column">
                                ...
                                <nav class="nav nav-pills flex-column">
                                    <a class="nav-link ml-5 my-1" href="#item-1-1-1">Activity 5.1</a>
                                    <a class="nav-link ml-5 my-1" href="#item-1-1-2">Activity 5.2</a>
                                </nav>
                                <a class="nav-link ml-3 my-1" href="#item-1-2">5.4.2 Computer as learner (Student as teacher)</a>
                                <a class="nav-link ml-3 my-1" href="#item-1-3">5.4.3 Using the Internet to support learning</a>
                                <a class="nav-link ml-3 my-1" href="#item-1-4">5.4.4 Uses of the Internet</a>
                            </nav>
                        </nav>
                    </nav>
                </div>
