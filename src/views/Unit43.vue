                ...
                <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                    ...
                    <nav class="nav nav-pills flex-column">
                        ...
                        <nav class="nav nav-pills flex-column">
                            ...
                            <a class="nav-link ml-3 my-1" href="#item-1-3">4.3.3 Examples of visuals that you could design</a>

                            <nav>
                                <a class="nav-link ml-5 my-1" href="#item-1-3-1">Assignment 4.1</a>
                            </nav>
                            <a class="nav-link ml-3 my-1" href="#item-1-4">4.3.4 Designing text </a>
                            <nav>
                                <a class="nav-link ml-5 my-1" href="#item-1-3-2">Activity 4.1</a>
                            </nav>
                            <a class="nav-link ml-3 my-1" href="#item-1-5">4.3.5 Chalkboard</a>
                            <nav>
                                <a class="nav-link ml-5 my-1" href="#item-1-3-3">Assignment 4.2</a>
                            </nav>
                            <a class="nav-link ml-3 my-1" href="#item-1-6">4.3.6 Whiteboard</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-7">4.3.7 Designing overhead transparencies </a>
                            <a class="nav-link ml-3 my-1" href="#item-1-8">4.3.8 Design of Power Point presentations</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-9">4.3.9 Designing audio media</a>
                            <a class="nav-link ml-3 my-1" href="#item-1-10">4.3.10 Designing  a PODCAST</a>
                            <nav>
                                <a class="nav-link ml-5 my-1" href="#item-1-3-4">Assignment 4.3</a>
                            </nav>
                        </nav>
                    </nav>
                </nav>
