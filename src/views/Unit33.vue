    ...
    <div class="row">
        <div class="col-sm-4 col-lg-3">
            <nav id="navbar-example3" class="navbar navbar-light bg-light flex-column mt-4">
                ...
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link active" href="#item-1">3.3 The Media Selection Process</a>
        ...
        <div class="col-sm-8 col-lg-9">
            <div data-spy="scroll" class="scrollspy-example z-depth-1 mt-4 shadow-lg p-3 mb-5 rounded" data-target="#navbar-example3"
                 data-offset="0">
                <h2 id="item-1" class="h2-responsive">3.3 The Media Selection Process</h2>
                ...
                <p class="textjustify meme">
                    <ul>
                        ...
                        <li>
                           Audience- <em>What are the characteristics of your learners? Do they have 
                            the prerequisite knowledge and skills to use or learn from the materials?</em>
                        </li>
                        <li>
                            Cost- <em>Do you have sufficient funds to meet the costs of the materials?</em>
                        </li>
                        <li>
                           Technical expertise- <em>do you have the necessary technical expertise to design 
                            and produce the kind of materials you wish to use?</em>
                        </li>
                        <li>
                            Equipment- <em>do you have the necessary equipment to produce or
                            use the materials that you intend to design?</em>
                        </li>
                        <li>
                            Facilities- <em>if your design calls for use of special facilities for 
                            preparation or use of the materials, are such facilities available?</em>
                        </li>
                        <li>
                           Time- <em>can you afford to spend whatever time necessary to design and
                            produce the kind of materials you have in mind?</em>
                        </li>
                    </ul>
                </p>
